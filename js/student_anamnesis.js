...
document.addEventListener('DOMContentLoaded', () => {
    // Verifica se o usuário é um estudante antes de exibir a anamnese
    const userRole = localStorage.getItem('userRole');
    if (userRole !== 'estudante') {
        // Se não for estudante, redireciona para a página inicial ou para o dashboard apropriado
        alert('Esta seção é exclusiva para estudantes. Você será redirecionado(a).');
        window.location.href = 'index.html'; // Ou para o dashboard do perfil logado
        return;
    }
